...
// Import Metadata type if needed for client component, but metadata is usually defined in page.tsx server component
// import { Metadata } from "next";

// Metadata should be defined in a server component or using the generateMetadata function
// Example (if this were a server component or using generateMetadata):
/*
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Wolkenticket support. We're available 24/7 via email, phone, or our contact form for any questions about your flight reservation.",
...
export default function Page() {
  ...
  return (
    <>
      <Navbar />
      {/* Metadata needs to be defined in a server component wrapper or using generateMetadata */}
      {/* For client components, you might need a different approach if dynamic metadata based on client state is required */}
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-12 sm:mb-16 md:mb-20">
              ...
              <motion.h2
                // Use h1 for the main page title for SEO
                as="h1"
